...
4. ⚠️ **Limited Comparison**: No built-in comparison tool
5. ⚠️ **Manual Selection**: No easy way to select items from multiple supplier quotations

### What's Missing

1. ❌ **Supplier Quotation Comparison Report**: Need to see all supplier quotations for same items
2. ❌ **Item Selection Interface**: Need easy way to select items from supplier quotations
3. ❌ **Price Breakdown Display**: Need to show original price, supplier price, expenses, final price
4. ❌ **Multi-Supplier Selection**: Need to select items from different supplier quotations
...
#### Feature 1: Supplier Quotation Comparison Dashboard

**Location:** Custom Report or Dashboard

**Functionality:**
- Shows all supplier quotations for items in Customer Quotation
- Groups by item_code
- Shows: Supplier, Rate, Amount, Valid Till, Lead Time
- Allows filtering and sorting
- Can be accessed from Customer Quotation form

**Implementation:**
- Use ERPNext's built-in "Supplier Quotation Comparison" report
- Enhance it to filter by Customer Quotation
- Add link from Customer Quotation form
...
**System State:**
- Material Request linked to Customer Quotation via `custom_dc_refrance`
- Items ready to be sent to suppliers

### Step 3: Create Request for Quotation (RFQ)

**Action:**
1. Create Request for Quotation
2. Link to Material Request (or create from Material Request)
...
2. Link to Material Request or RFQ
3. Submit Supplier Quotations

**System State:**
- Multiple Supplier Quotations exist
- All linked to same Material Request
- Can be compared
...
def get_supplier_quotation_items(quotation_name):
    ...
    """
    # Get Material Request linked to quotation
